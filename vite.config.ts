    ...
    <main class="min-h-screen bg-background text-foreground">
      <div class="mx-auto flex min-h-screen w-full max-w-md flex-col px-6 py-12">
        ...
        <nav class="flex flex-col gap-3" aria-label="Links">
          <a href="https://wa.me/5562996119964" target="_blank" rel="noopener noreferrer" class="flex items-center gap-4 rounded-xl border border-white/10 bg-white/[0.03] px-5 py-4 transition-colors hover:bg-white/[0.06]">
          ...
          <a href="https://lojastyle.shop" target="_blank" rel="noopener noreferrer" class="flex items-center gap-4 rounded-xl border border-white/10 bg-white/[0.03] px-5 py-4 transition-colors hover:bg-white/[0.06]">
          ...
          <a href="https://share.google/ViFg28XnnnbgOIe1d" target="_blank" rel="noopener noreferrer" class="flex items-center gap-4 rounded-xl border border-white/10 bg-white/[0.03] px-5 py-4 transition-colors hover:bg-white/[0.06]">
