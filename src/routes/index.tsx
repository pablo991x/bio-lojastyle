        ...
        <nav className="flex flex-col gap-3" aria-label="Links">
          {links.map(({ label, sublabel, href, icon: Icon, accent }) => (
            <a
              ...
              className="group relative flex items-center gap-4 rounded-xl border border-white/10 bg-white/[0.03] px-5 py-4 transition-all duration-300 hover:scale-[1.02] hover:bg-white/[0.06] hover:shadow-[0_0_20px_rgba(59,130,246,0.15)]"
            >
              <div className="absolute -inset-1 -z-10 rounded-2xl bg-blue-500/10 opacity-0 blur-xl transition-opacity duration-300 group-hover:opacity-100" />
              <span
